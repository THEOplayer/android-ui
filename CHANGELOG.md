...
* 🐛 The language menu now shows CEA-608/708 closed caption tracks with their localized language name (if available) instead of their channel number (e.g. "CC1"). ([#84](https://github.com/THEOplayer/android-ui/pull/84))
